...
TERMS = [
	...
	['tener','le','lo','lo','todo','pero','mas','hacer','o','poder','decir','este','ir','otro'],
	['ese','la','si','me','ya','ver','porque','dar','cuando','el','muy','sin','vez','mucho'],
	['saber','que','sobre','mi','alguno','mismo','yo','tambien','hasta','año','dos','querer'],
	['entre','asi','primero','desde','grande','eso','ni','nos','llegar','pasar','tiempo','ella'],
	['si','dia','uno','bien','poco','deber','entonces','poner','cosa','tanto','hombre','parecer'],
	['nuestro','tan','donde','ahora','parte','despues','vida','quedar','siempre','creer','hablar'],
	['llevar','dejar','nada','cada','seguir','menos','nuevo']
]
...
TERMS.each do |terms|
	...
	@threads << Thread.new{ get_tweets(terms) }
end
